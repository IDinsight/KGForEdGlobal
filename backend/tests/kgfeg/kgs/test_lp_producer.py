...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ...
        "retain verbatim and without duplicates every warning supplied in the request",
        "including warnings about SFIs that are not the pair's endpoints",
        "Never filter warnings for perceived relevance",
