...
python src/kgfeg/entries/extract_page_ir.py ../examples/tanzania/config.json
"""
...
# Package Library
from kgfeg.page_ir_extraction.llm import ExtractionUsageTracker, extract_page_ir
...
from kgfeg.page_ir_extraction.validators import compute_boundary_state_from_items
from kgfeg.schemas import ExtractionConfig, RunConfig
from kgfeg.utils.general import open_json_type, write_to_json
from kgfeg.utils.pdf import validate_page_count
