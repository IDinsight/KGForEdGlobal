...
python src/kgfeg/entries/create_kgs.py ../examples/ghana/config_math_curriculum.json
"""
...
# Package Library
from kgfeg.kgs.lc_dedup import group_duplicate_skills
from kgfeg.kgs.lc_export import compile_as_lc_kg
from kgfeg.kgs.lc_finalization import (
    build_lc_supports_edges,
    mint_learning_components,
    summarize_learning_components,
)
from kgfeg.kgs.lc_generation import (
...
from kgfeg.kgs.sfi_extraction_windows import (
    build_llm_extraction_windows,
    plan_extraction_windows,
)
from kgfeg.kgs.sfi_finalization import mint_final_sfi_ids
from kgfeg.kgs.sfi_registry import build_candidate_registry
from kgfeg.kgs.sfi_relationships import resolve_has_child_edges
