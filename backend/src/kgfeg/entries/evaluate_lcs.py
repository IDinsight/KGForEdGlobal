...
python src/kgfeg/entries/evaluate_lcs.py rubric --replicates 3
python src/kgfeg/entries/evaluate_lcs.py edges --concurrency 16
"""
...
from kgfeg.evals.lc_eval.judge import (
    JUDGE_CONCURRENCY,
    judge_model_config,
    run_edge_judging,
    run_rubric_judging,
)
from kgfeg.evals.lc_eval.sampling import (
...
from kgfeg.evals.lc_eval.scoring import (
    build_edge_report,
    build_rubric_report,
    write_edge_report,
    write_rubric_report,
)
from kgfeg.utils.general import make_dir
from kgfeg.utils.logging_ import logger
