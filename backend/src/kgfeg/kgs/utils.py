...
from kgfeg.document_ir.schemas import DocumentIR, TableSegment
from kgfeg.page_ir_extraction.schemas import TableCell, TextUnit
from kgfeg.schemas import CreateKGConfig, ExtractionConfig, RunCtx
