...
### 4. Academic Standards extraction is LLM-driven by design
...
### 5. No-code support is mandatory
...
### 6. Preserve original language and provenance
...
### 7. Treat table helper views as helpful but optional
...
### 8. Use candidates before final KG nodes
...
### 10. Relationship endpoint rules
...
### 11. Validation is part of the product
