...
2. JSON files:
    ...
    - `document_ir.json`: the stitched DocumentIR output for Zambia's literacy and language curriculum PDF
    - `kg_run_manifest.json`: output from the KG prep stage for the Zambia's literacy and language curriculum
