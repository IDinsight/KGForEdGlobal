...
- For every SFI candidate, source_text must be a contiguous excerpt of description, or contain the complete description with a visible source code or surrounding source text. Do not use an unrelated quote from another cited row or source unit.
