...
The amended order retains Step 26 six complete pipelines after revalidated Steps 24–25. The user approved the early-start extension on 2026-09-11, as recorded in brief Section 3.3; D12.1.1 allows Step 27 coding and subsequent independent offline testing to overlap Step 26 using a validated frozen Madhi development snapshot. The harness is generalized for any selected N >= 1 compatible curricula; the initial six are a project-completion population, not a runtime roster/count. Missing unselected future outputs do not block development, but selected invalid/missing inputs fail. Live evaluation and final Step 27 approval still require Step 26 reviewer approval and all six reviewed snapshots, complete evaluation/reporting and concern disposition. Step 28 documentation and Step 29 comprehensive review follow; a Madhi-only development result is not Step 27 completion. The global no-required-sample/metric rule changed at Step 24, so the user's adoption on 2026-09-11 reopens Steps 24–25 at review base `540ea950378ce54b54da1c7a93491b525609b574`; distinguish the recorded user specification approval from independent reviewer approval of code or steps, and do not imply it authorizes production tuning, live calls or bypassing progression gates.
