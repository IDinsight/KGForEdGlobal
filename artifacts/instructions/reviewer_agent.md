...
Verify D12.1.3 treats the production run Git SHA as optional provenance, including final Step 28 completion. Missing producing commits alone are not failures or concerns requiring disposition; required artifact/config identities and evaluator candidate/review-base SHAs remain mandatory.
