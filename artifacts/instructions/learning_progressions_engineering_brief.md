...
**SETTLED — Current-format-only evaluator inputs; implementation approval recorded under Section 3.3.9.**
...
### D12.1.5 SETTLED — Remove historical evaluator compatibility; implementation approval recorded
